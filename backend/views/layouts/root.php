                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="username username-hide-on-mobile"> <?php echo Yii::$app->session->get('root_session')['username']; ?> </span>
                                    <i class="fa fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a href="<?php echo Url::to(['root/my']); ?>">
                                            <i class="icon-user"></i> 账户管理 </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="log-out" href="<?php echo Url::to(['root/login/out']); ?>">
            ...
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start <?php if(Yii::$app->controller->id == 'root/site' && Yii::$app->controller->action->id == 'index') echo 'active'; ?>">
                            <a href="<?php echo Url::to(['/root/site']); ?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
