    ...
    <div class="col-md-12">
       <div class="portlet light ">            
            <div class="portlet-body form">
                <form class="form-horizontal recommend-post-form" role="form" novalidate="novalidate">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                 <div class="icheck-inline">
                                    <label>
                                        <input type="radio" name="display_order" <?php if($recommendType == 1) echo 'checked'; ?> class="icheck" value="1"> 首页左侧
                                    </label>
                                    <label>
                                        <input type="radio" name="display_order" <?php if($recommendType == 2) echo 'checked'; ?> class="icheck" value="2"> 首页左侧上
                                    </label>
                                    <label>
                                        <input type="radio" name="display_order" <?php if($recommendType == 3) echo 'checked'; ?> class="icheck" value="3"> 首页上右侧上
                                    </label>
                                    <label style="margin-left: 0;">
                                        <input type="radio" name="display_order" <?php if($recommendType == 4) echo 'checked'; ?> class="icheck" value="4"> 首页上右侧下
                                    </label>
                                    <label>
                                        <input type="radio" name="display_order" <?php if($recommendType == 0) echo 'checked'; ?> class="icheck" value="0"> 取消推荐
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="act" value="recomend">
